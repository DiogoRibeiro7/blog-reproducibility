"""Reproduce the storage ledger calculations and figure."""
...
from blog_reproducibility.engineering.storage_ledger import example_payload
from blog_reproducibility.engineering.storage_ledger_figure import render_storage_figure


def main() -> None:
    """Print the dispatch ledger and optionally render the figure."""
    ...
    payload: dict[str, object] = {"configurations": to_jsonable(example_payload())}
    if not args.dry_run:
        payload["figures"] = describe_figures((render_storage_figure(output_dir=args.output_dir),))
