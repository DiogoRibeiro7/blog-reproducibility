"""Report the recorded data lake benchmark and render its figures.
...
from blog_reproducibility.engineering.data_lake_benchmarks import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(render_data_lake_figures(output_dir=args.output_dir))
