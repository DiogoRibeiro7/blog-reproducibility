"""Reproduce the numerical verification calculations and figure."""
...
from blog_reproducibility.engineering.numerical_verification import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_refinement_figure(output_dir=args.output_dir),)
        )
