"""Reproduce the queueing simulations and figure."""
...
from blog_reproducibility.mathematics.queueing import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures((render_queueing_figure(output_dir=args.output_dir),))
