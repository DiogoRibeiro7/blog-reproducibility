"""Reproduce the distance-concentration tables and figure."""
...
from blog_reproducibility.mathematics.distance_concentration import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_concentration_figure(output_dir=args.output_dir, summary=summary),)
        )
