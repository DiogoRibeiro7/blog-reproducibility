"""Reproduce the central limit theorem figure."""
...
from blog_reproducibility.mathematics.central_limit import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_convergence_figure(output_dir=args.output_dir),)
        )
