"""Reproduce the Metropolis sampling diagnostics and figure."""
...
from blog_reproducibility.mathematics.metropolis import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures((render_trace_figure(output_dir=args.output_dir),))
