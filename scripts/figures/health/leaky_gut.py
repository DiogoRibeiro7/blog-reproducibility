"""Reproduce the leaky gut calculations and figures."""
...
from blog_reproducibility.health.leaky_gut import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(render_leaky_gut_figures(output_dir=args.output_dir))
