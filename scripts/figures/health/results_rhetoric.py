"""Reproduce the results rhetoric calculations and figures."""
...
from blog_reproducibility.health.results_rhetoric import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_results_rhetoric_figures(output_dir=args.output_dir)
        )
