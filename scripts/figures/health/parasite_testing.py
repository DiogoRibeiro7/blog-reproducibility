"""Reproduce the parasite testing calculations and figures."""
...
from blog_reproducibility.health.parasite_testing import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_parasite_testing_figures(output_dir=args.output_dir)
        )
