"""Reproduce the screening and survival calculations and figures."""
...
from blog_reproducibility.health.screening_survival import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_screening_survival_figures(output_dir=args.output_dir)
        )
