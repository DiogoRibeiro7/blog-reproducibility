"""Reproduce the microbiome testing calculations and figures."""
...
from blog_reproducibility.health.microbiome_testing import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_microbiome_testing_figures(output_dir=args.output_dir)
        )
