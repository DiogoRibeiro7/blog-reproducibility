"""Reproduce the aspartame dose calculations and figures."""
...
from blog_reproducibility.health.aspartame_dose import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(render_aspartame_figures(output_dir=args.output_dir))
