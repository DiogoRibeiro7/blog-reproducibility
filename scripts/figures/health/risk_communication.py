"""Reproduce the concentration and starting-risk calculations and figures."""
...
from blog_reproducibility.health.risk_communication import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (
                render_concentration_figure(output_dir=args.output_dir),
                render_relative_risk_figure(output_dir=args.output_dir),
            )
        )
