"""Reproduce the inflammation marker calculations and figures."""
...
from blog_reproducibility.health.inflammation_markers import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_inflammation_figures(output_dir=args.output_dir)
        )
