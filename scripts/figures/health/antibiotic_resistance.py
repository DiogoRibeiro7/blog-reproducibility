"""Reproduce the antibiotic selection calculations and figure."""
...
from blog_reproducibility.health.antibiotic_resistance import example_payload
from blog_reproducibility.health.antibiotic_resistance_figure import render_selection_figure
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_selection_figure(output_dir=args.output_dir),)
        )
