"""Reproduce the censored-labels tables and figure."""
...
from blog_reproducibility.machine_learning.censored_labels import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_cohorts_figure(output_dir=args.output_dir, summary=summary),)
        )
