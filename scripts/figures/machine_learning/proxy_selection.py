"""Reproduce the proxy-selection gains and figure."""
...
from blog_reproducibility.machine_learning.proxy_selection import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_proxy_selection_figure(output_dir=args.output_dir, summary=summary),)
        )
