"""Reproduce the feature-selection leakage curves and figure."""
...
from blog_reproducibility.machine_learning.selection_leakage import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_selection_leakage_figure(output_dir=args.output_dir, summary=summary),)
        )
