"""Reproduce the learning-curve tables, power-law fits and figure."""
...
from blog_reproducibility.machine_learning.learning_curves import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_learning_curves_figure(output_dir=args.output_dir, summary=summary),)
        )
