"""Reproduce the permutation-importance tables and figure."""
...
from blog_reproducibility.machine_learning.permutation_importance import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_permutation_importance_figure(output_dir=args.output_dir, summary=summary),)
        )
