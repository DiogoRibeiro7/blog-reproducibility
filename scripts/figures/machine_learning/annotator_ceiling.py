"""Reproduce the annotator ceiling simulation and figure."""
...
from blog_reproducibility.machine_learning.annotator_ceiling import example_payload
from blog_reproducibility.machine_learning.annotator_ceiling_figure import (
    render_annotator_ceiling_figure,
)
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_annotator_ceiling_figure(output_dir=args.output_dir, curves=summary.curves),)
        )
