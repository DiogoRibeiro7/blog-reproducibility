"""Reproduce the winner's-curse optimism simulation and figure."""
...
from blog_reproducibility.machine_learning.winners_curse import example_payload
from blog_reproducibility.machine_learning.winners_curse_figure import render_winners_curse_figure
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_winners_curse_figure(output_dir=args.output_dir, curves=summary.curves),)
        )
