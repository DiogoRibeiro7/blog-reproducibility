"""Reproduce the bandit regret curves and figure."""
...
from blog_reproducibility.machine_learning.bandit_regret import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_bandit_regret_figure(output_dir=args.output_dir, summary=summary),)
        )
