"""Reproduce the seasons geometry, the heat-storage response, and the figure."""
...
from blog_reproducibility.physics.seasons import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_tilt_geometry_figure(output_dir=args.output_dir),)
        )
