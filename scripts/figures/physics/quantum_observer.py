"""Reproduce the quantum measurement calculations and figures."""
...
from blog_reproducibility.physics.quantum_observer import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_quantum_observer_figures(output_dir=args.output_dir)
        )
