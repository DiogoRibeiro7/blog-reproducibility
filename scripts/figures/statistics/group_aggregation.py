"""Reproduce the group aggregation curves, the article's closed forms and the figure."""
...
from blog_reproducibility.statistics.group_aggregation import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_group_aggregation_figure(output_dir=args.output_dir, summary=summary),)
        )
