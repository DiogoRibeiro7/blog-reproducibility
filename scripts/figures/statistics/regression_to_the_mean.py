"""Reproduce the regression-to-the-mean fleet, placebo, intervention, closed forms and figure."""
...
from blog_reproducibility.statistics.regression_to_the_mean import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_regression_to_the_mean_figure(output_dir=args.output_dir),)
        )
