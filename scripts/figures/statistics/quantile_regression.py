"""Reproduce the delivery-time quantile regression tables and figure."""
...
from blog_reproducibility.statistics.quantile_regression import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_quantile_regression_figure(output_dir=args.output_dir, summary=summary),)
        )
