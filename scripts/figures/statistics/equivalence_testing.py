"""Reproduce the equivalence-testing simulation, its exact rates, sample sizes and figure."""
...
from blog_reproducibility.statistics.equivalence_testing import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_equivalence_figure(output_dir=args.output_dir, summary=summary),)
        )
