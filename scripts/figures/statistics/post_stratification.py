"""Reproduce the survey weighting curves, their closed forms and the figure."""
...
from blog_reproducibility.statistics.post_stratification import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_post_stratification_figure(output_dir=args.output_dir, summary=summary),)
        )
