"""Reproduce the one-factor-at-a-time and factorial design comparison and its figure."""
...
from blog_reproducibility.statistics.factorial_designs import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_factorial_designs_figure(output_dir=args.output_dir, summary=summary),)
        )
