"""Reproduce the ratio-metric A/A false positive rates, closed forms and figure."""
...
from blog_reproducibility.statistics.ratio_metrics import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_ratio_metric_figure(output_dir=args.output_dir, summary=summary),)
        )
