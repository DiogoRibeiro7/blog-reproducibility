"""Reproduce the percentile-precision simulation, closed forms and figure."""
...
from blog_reproducibility.statistics.percentile_metrics import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_percentile_figure(output_dir=args.output_dir, rows=summary.simulated),)
        )
