"""Reproduce the peaks-over-threshold fit, return levels, bootstrap and tail figure."""
...
from blog_reproducibility.statistics.extreme_values import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_extreme_values_figure(output_dir=args.output_dir, summary=summary),)
        )
