"""Reproduce the regression discontinuity bandwidth trade-off, closed forms and figure."""
...
from blog_reproducibility.statistics.regression_discontinuity import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_regression_discontinuity_figure(output_dir=args.output_dir, summary=summary),)
        )
