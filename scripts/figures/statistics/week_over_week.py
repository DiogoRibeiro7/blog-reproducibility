"""Reproduce the week-over-week noise distributions, their closed forms and the figure."""
...
from blog_reproducibility.statistics.week_over_week import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_week_over_week_figure(output_dir=args.output_dir, summary=summary),)
        )
