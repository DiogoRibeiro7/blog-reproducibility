"""Reproduce the monitoring charts' detection delays, the run-length closed forms and figure."""
...
from blog_reproducibility.statistics.run_length import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_run_length_figure(output_dir=args.output_dir, summary=summary),)
        )
