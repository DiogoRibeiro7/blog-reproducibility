"""Reproduce the switchback period-length simulation, closed forms and figure."""
...
from blog_reproducibility.statistics.switchback import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_switchback_figure(output_dir=args.output_dir, rows=summary.rows),)
        )
