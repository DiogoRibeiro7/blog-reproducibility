"""Reproduce the randomisation balance calculations and figure."""
...
from blog_reproducibility.statistics.randomisation_balance import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures((render_balance_figure(output_dir=args.output_dir),))
