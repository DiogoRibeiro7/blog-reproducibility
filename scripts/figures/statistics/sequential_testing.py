"""Reproduce the sequential-testing boundaries, recursion results and figure."""
...
from blog_reproducibility.statistics.sequential_testing import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_sequential_figure(output_dir=args.output_dir, boundaries=summary.figure),)
        )
