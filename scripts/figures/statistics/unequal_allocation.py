"""Reproduce the unequal-allocation cost tables and figure."""
...
from blog_reproducibility.statistics.unequal_allocation import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_allocation_figure(output_dir=args.output_dir),)
        )
