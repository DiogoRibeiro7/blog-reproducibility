"""Reproduce the propensity score estimator comparison, closed forms and figure."""
...
from blog_reproducibility.statistics.propensity_scores import example_payload
from blog_reproducibility.statistics.propensity_scores_figure import render_propensity_scores_figure
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_propensity_scores_figure(output_dir=args.output_dir, summary=summary),)
        )
