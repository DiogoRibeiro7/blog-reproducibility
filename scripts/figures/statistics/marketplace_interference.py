"""Reproduce the marketplace interference simulation, worked day and figure."""
...
from blog_reproducibility.statistics.marketplace_interference import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_marketplace_figure(output_dir=args.output_dir, rows=summary.rows),)
        )
