"""Reproduce the block bootstrap coverage table, closed forms and figure."""
...
from blog_reproducibility.statistics.block_bootstrap import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_block_bootstrap_figure(output_dir=args.output_dir, summary=summary),)
        )
