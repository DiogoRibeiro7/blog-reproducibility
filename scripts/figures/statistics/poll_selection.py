"""Reproduce the poll-selection calculations and figures."""
...
from blog_reproducibility.statistics.poll_selection import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_poll_selection_figures(output_dir=args.output_dir)
        )
