"""Reproduce the attenuation slopes, the leakage table, the SIMEX extrapolations and the figure."""
...
from blog_reproducibility.statistics.measurement_error import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_measurement_error_figure(output_dir=args.output_dir, summary=summary),)
        )
