"""Reproduce the confidence-set calculations and figures."""
...
from blog_reproducibility.statistics.confidence_sets import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_confidence_set_figures(output_dir=args.output_dir)
        )
