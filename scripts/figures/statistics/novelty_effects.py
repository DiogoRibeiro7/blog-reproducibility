"""Reproduce the novelty-effect tenure and calendar curves and figure."""
...
from blog_reproducibility.statistics.novelty_effects import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_novelty_figure(output_dir=args.output_dir, summary=summary),)
        )
