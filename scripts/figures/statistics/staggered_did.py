"""Reproduce the staggered difference-in-differences event study, closed forms and figure."""
...
from blog_reproducibility.statistics.staggered_did import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_staggered_did_figure(output_dir=args.output_dir, summary=summary),)
        )
