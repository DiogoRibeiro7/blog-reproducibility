"""Reproduce the coin-streak calculations and figure."""
...
from blog_reproducibility.statistics.coin_streaks import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_mechanisms_figure(output_dir=args.output_dir),)
        )
