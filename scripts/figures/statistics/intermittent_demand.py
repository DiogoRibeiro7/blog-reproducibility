"""Reproduce the intermittent demand forecast averages, errors, closed forms and figure."""
...
from blog_reproducibility.statistics.intermittent_demand import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_intermittent_demand_figure(output_dir=args.output_dir, summary=summary),)
        )
