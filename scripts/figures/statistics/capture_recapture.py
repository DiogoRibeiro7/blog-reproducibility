"""Reproduce the capture-recapture estimates, their closed forms and the figure."""
...
from blog_reproducibility.statistics.capture_recapture import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_capture_recapture_figure(output_dir=args.output_dir, summary=summary),)
        )
