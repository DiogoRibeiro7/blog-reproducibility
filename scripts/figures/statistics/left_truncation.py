"""Reproduce the fleet survival curves, the article's numbers and the figure."""
...
from blog_reproducibility.statistics.left_truncation import example_payload
from blog_reproducibility.statistics.left_truncation_figure import render_left_truncation_figure
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_left_truncation_figure(output_dir=args.output_dir, summary=summary),)
        )
