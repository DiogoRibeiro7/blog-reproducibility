"""Reproduce the longitudinal design calculations and figure."""
...
from blog_reproducibility.statistics.longitudinal_design import example_payload
from blog_reproducibility.statistics.longitudinal_design_figure import render_budget_figure
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures((render_budget_figure(output_dir=args.output_dir),))
