"""Reproduce the trigger-dilution sample sizes, visibility table and figure."""
...
from blog_reproducibility.statistics.trigger_dilution import example_payload
from blog_reproducibility.statistics.trigger_dilution_figure import (
    render_trigger_dilution_figure,
)
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_trigger_dilution_figure(output_dir=args.output_dir),)
        )
