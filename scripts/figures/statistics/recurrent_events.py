"""Reproduce the fleet's mean cumulative function, the article's numbers and the figure."""
...
from blog_reproducibility.statistics.recurrent_events_figure import render_recurrent_events_figure
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_recurrent_events_figure(output_dir=args.output_dir, summary=summary),)
        )
