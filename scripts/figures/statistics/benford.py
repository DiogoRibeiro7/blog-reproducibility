"""Reproduce the Benford spread curve, its closed forms and the figure."""
...
from blog_reproducibility.statistics.benford import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_benford_figure(output_dir=args.output_dir, summary=summary),)
        )
