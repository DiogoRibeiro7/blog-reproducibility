"""Reproduce the negative control tracking curve, closed forms and figure."""
...
from blog_reproducibility.statistics.negative_controls import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_negative_control_figure(output_dir=args.output_dir, curve=summary.curve),)
        )
