"""Reproduce the sample ratio mismatch simulation, closed forms and figure."""
...
from blog_reproducibility.statistics.sample_ratio_mismatch import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_mismatch_figure(output_dir=args.output_dir, rows=summary.rows),)
        )
