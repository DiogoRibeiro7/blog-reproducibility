"""Reproduce the heaped threshold curves, the closed forms behind the tables and the figure."""
...
from blog_reproducibility.statistics.digit_heaping import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_digit_heaping_figure(output_dir=args.output_dir, summary=summary),)
        )
