"""Reproduce the Berkson's paradox correlations, regressions, closed forms and figure."""
...
from blog_reproducibility.statistics.berkson_selection import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_berkson_selection_figure(output_dir=args.output_dir, curve=summary.curve),)
        )
