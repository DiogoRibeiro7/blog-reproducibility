"""Reproduce the cluster-randomised A/A false positive rates, closed forms and figure."""
...
from blog_reproducibility.statistics.cluster_randomisation import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_cluster_figure(output_dir=args.output_dir, summary=summary),)
        )
