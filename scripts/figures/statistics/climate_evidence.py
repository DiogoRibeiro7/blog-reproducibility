"""Reproduce the climate evidence calculations and figures."""
...
from blog_reproducibility.statistics.climate_evidence import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            render_climate_evidence_figures(output_dir=args.output_dir)
        )
