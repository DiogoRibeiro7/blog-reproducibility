"""Reproduce the offline change-point tables and figure."""
...
from blog_reproducibility.time_series.optimal_partition import example_payload
from blog_reproducibility.time_series.optimal_partition_figure import render_segmentation_figure
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_segmentation_figure(output_dir=args.output_dir),)
        )
