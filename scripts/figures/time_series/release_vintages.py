"""Reproduce the GDP release vintage calculations and figure."""
...
from blog_reproducibility.time_series.release_vintages import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures((render_vintages_figure(output_dir=args.output_dir),))
