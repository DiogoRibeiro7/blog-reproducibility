"""Reproduce the synthetic control estimates and figure."""
...
from blog_reproducibility.data_science.synthetic_control import example_payload
from blog_reproducibility.data_science.synthetic_control_figure import (
    render_synthetic_control_figure,
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=DEFAULT_FIGURE_OUTPUT_DIR / "data_science",
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_synthetic_control_figure(output_dir=args.output_dir),)
        )
