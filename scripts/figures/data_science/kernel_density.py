"""Reproduce the kernel density bandwidth figure."""
...
from blog_reproducibility.data_science.kernel_density import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_bandwidth_figure(output_dir=args.output_dir),)
        )
