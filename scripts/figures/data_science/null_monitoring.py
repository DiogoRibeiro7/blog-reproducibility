"""Reproduce the null-rate monitoring simulation and figure."""
...
from blog_reproducibility.data_science.null_monitoring import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_detection_figure(output_dir=args.output_dir, summary=summary),)
        )
