"""Reproduce the two-dimensional histogram outlier figure."""
...
from blog_reproducibility.data_science.histogram_outliers import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_histogram_figure(output_dir=args.output_dir),)
        )
