"""Reproduce the Savitzky-Golay smoothing figure."""
...
from blog_reproducibility.data_science.savitzky_golay import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_smoothing_figure(output_dir=args.output_dir),)
        )
