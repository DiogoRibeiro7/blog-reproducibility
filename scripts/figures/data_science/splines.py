"""Reproduce the spline and polynomial fits and figure."""
...
from blog_reproducibility.data_science.splines import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures((render_splines_figure(output_dir=args.output_dir),))
