"""Reproduce the Lorenz curve and Gini coefficient figure."""
...
from blog_reproducibility.economics.inequality import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures(
            (render_lorenz_gini_figure(output_dir=args.output_dir),)
        )
