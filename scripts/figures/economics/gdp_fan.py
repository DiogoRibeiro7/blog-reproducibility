"""Reproduce the Monte Carlo GDP fan chart."""
...
from blog_reproducibility.economics.gdp_fan import example_payload
...
def main() -> None:
    ...
    if not args.dry_run:
        payload["figures"] = describe_figures((render_fan_figure(output_dir=args.output_dir),))
