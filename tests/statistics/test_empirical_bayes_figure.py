"""Tests for the empirical Bayes shrinkage figure rendering."""
...
def test_renderer_writes_the_expected_png(tmp_path: Path) -> None:
    ...
    artifact = render_empirical_bayes_figure(output_dir=tmp_path)

    assert artifact.path == tmp_path / "empirical_bayes_shrinkage.png"
