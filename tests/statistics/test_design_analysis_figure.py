"""Tests for the Type S and Type M figure rendering."""
...
def test_renderer_writes_the_expected_png(tmp_path: Path) -> None:
    ...
    artifact = render_design_analysis_figure(output_dir=tmp_path)

    assert artifact.path == tmp_path / "design_analysis_type_sm.png"
